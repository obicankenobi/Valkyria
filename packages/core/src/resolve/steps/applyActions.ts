...
//
// P17 byggde house.actionPoints (8.1) och INTERNAL i sin helhet (8.2). P18 bygger
...
import type { FactionId, GameState, Money, ProductionLine, RndProject, Station, TechCategory, WireEvent } from '../../types.js'
